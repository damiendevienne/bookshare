...
export default function PasswordResetPage() {
  ...
  useEffect(() => {
    ...
    api.get("/api/auth/reset-password/validate", { params: { code } })
      ...
      .catch((err) => { if (active) setError(err.response?.data?.error?.message || "This reset link is invalid or has expired."); })
